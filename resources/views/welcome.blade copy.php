...
@section('content')
    ...
    <style>
        .login_img_section {
            background: linear-gradient(rgba(2, 2, 2, .7), rgba(0, 0, 0, .7)), url(https://images.pexels.com/photos/590022/pexels-photo-590022.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1) center center;
        }
    </style>
    <div class="h-screen flex">
        <div class="hidden lg:flex w-full lg:w-1/2 login_img_section justify-around items-center">
            ...
            <div class="w-full mx-auto px-20 flex-col items-center space-y-6">
                <h1 class="text-white font-bold text-4xl font-sans">DPMPTSP <span class="font-light"> Provinsi Jawa
                        Tengah</span></h1>
                <p class="text-white mt-1">Aplikasi Survey Kepuasan Masyarakat</p>
            ...
            <div class="w-full px-8 md:px-32 lg:px-24">
                <form class="bg-white rounded-md shadow-2xl p-5">
                    ...
                    <a href="{{ route('notfound') }}" type="submit"
                        class="block w-full bg-indigo-600 mt-5 py-2 rounded-2xl hover:bg-gray-500 hover:-translate-y-1 transition-all duration-500 text-white font-semibold mb-2 text-center">Submit</a>

                    <a href="{{ route('pemohon') }}" type="submit"
                        class="block w-full bg-red-600 mt-5 py-2 rounded-2xl hover:bg-gray-500 hover:-translate-y-1 transition-all duration-500 text-white font-semibold mb-2 text-center">Tidak
                        Memiliki Nomor Tiket !</a>
