    ...
    <div class="max-w-4xl flex items-center h-full lg:h-screen flex-wrap mx-auto my-48 lg:my-0">
        ...
        <div id="profile" class="w-full lg:w-full lg:rounded-l-lg lg:rounded-r-lg shadow-2xl bg-white opacity-85 mx-6 lg:mx-0 rounded">
            ...
            <div class="p-4 md:p-12 text-center lg:text-left">
                ...
                <h1 class="text-3xl font-bold pt-8 lg:pt-0">DPMPTSP Provinsi Jawa Tengah</h1>
                {{-- <h2 data-aos="fade-up" data-aos-delay="400">Aplikasi Survey Kepuasan Masyarakat</h2> --}}
                <p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">Aplikasi Survey Kepuasan Masyarakat</p>
                <a href="https://skm.dpmptsp.jatengprov.go.id/nilai-skm">
                  <button class="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full mt-5">
                    LIHAT NILAI SKM
                  </button> 
                </a>
                <div class="pt-12 pb-8">
                  <h2 data-aos="fade-up" data-aos-delay="400"><marquee>Selamat Datang di Aplikasi SKM DPMPTSP Provinsi Jawa Tengah</marquee></h2>
                ...
                <div class="container px-4">
                  <div class="font-sans rounded-lg p-4 text-center">
                      ...
                      <div class="w-full text-center pt-4">
                          <form action="{{route('pemohon-izin')}}">
                            @csrf
                                ...
                                <div class="max-w-xl mx-auto p-1 pr-0 flex text-center">
                                    <div class="text-center items-center justify-center flex-1 mt-4 block md:inline-block border bg-black border-gray-400 p-3 appearance-none text-white text-base font-semibold tracking-wider uppercase py-4 rounded shadow-md">
                                        <p>Scan QR Code Untuk Pengisian SKM Melalui Smartphone :</p>
                                        <div class="flex flex-row bg-dark text-center items-center rounded mt-2" style="place-content: center;">
                                        <img src="qr-code.png" class="bg-dark card-img-top" alt="..." style="width: 96px">
                                        <img src="ptsp.png" class="bg-dark card-img-top" alt="..." style="width: 96px">
                                        </div>
                                    </div>
                                </div>
